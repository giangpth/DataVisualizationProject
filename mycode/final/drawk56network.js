...
function explainNetwork()
{
    ...
    expsvg.append('text')
        ...
        .text('Network: Connections on Facebook of 6 members in the class with other classmates')
        .style('font-weight', 'bold')
    ...
    expsvg.append('text')
        ...
        .attr('y', 50)
        .attr('text-anchor', 'begin')
        .text('The network shows the connections on Facebook of Giang, Trung Anh, Nguyen Ngo Dinh, Khac Quan, Dang Minh Cong, Hung Thinh with other classmates.')
